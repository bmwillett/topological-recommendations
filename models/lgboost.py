...
def features(order_data, product_data,verbose=1):
    """
    ...
    some code for features and lgboost training borrowed from:
        https://www.kaggle.com/paulantoine/light-gbm-benchmark-0-3692

    """

    # CURRENTLY JUST RELOADING CSV's, LATER REDO WITH STANDARD DATA FORMAT!

    IDIR = '../data/instacart_2017_05_01'
...
def lgboost_model_predict(train_order_data, train_last_order, product_data):

    df_train = features(train_order_data)

    d_train = lgb.Dataset(df_train, label=labels,
